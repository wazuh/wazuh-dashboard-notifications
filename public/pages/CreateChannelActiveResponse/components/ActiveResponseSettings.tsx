...
const DEFAULT_TIMEOUT_MINUTES_LABEL = secondsToMinutesLabel(
  ACTIVE_RESPONSE_DEFAULT_STATEFUL_TIMEOUT
);
    ...
    <div style={{ maxWidth: '700px' }}>
      ...
      {props.attributes.type === ACTIVE_RESPONSE_TYPE.STATEFUL && (
        ...
        >
          <EuiCompressedFieldNumber
            ...
            onChange={(e) =>
              props.setAttribute('statefulTimeout', Number(e.target.value))
            }
            onBlur={() => {
              context.setInputErrors({
                ...context.inputErrors,
                statefulTimeout: validateStatefulTimeout(
        ...
        <EuiCompressedSuperSelect
          ...
          options={[
            ...
            },
            {
              ...
              inputDisplay:
                ACTIVE_RESPONSE_LOCATION_LABEL[ACTIVE_RESPONSE_LOCATION.ALL],
              dropdownDisplay: (
                <>
                  <strong>
                    {
      ...
      {props.attributes.location === ACTIVE_RESPONSE_LOCATION.ALL && (
        <>
          ...
          >
            <p>
              Fleet-wide responses are rarely intended. If the goal is to act on
              the machine that raised the alert, choose <strong>Local</strong>.
              Ask an administrator to validate the executable in a
