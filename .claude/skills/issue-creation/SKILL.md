...
> stale upstream `bug` / `enhancement` names in their frontmatter — see step 4
> for the real labels to apply instead. `compatibility_request.md` and
> `task_template.md`'s labels (`request/operational`, `level/task`,
